...
--
-- Host: 127.0.0.1
-- Czas generowania: 14 Sty 2023, 02:56
...
INSERT INTO `days` (`id`, `offer_addres_id`, `dzien`, `od`, `do`) VALUES
(4, 5, 'Poniedziałek', '06:00:00', '18:01:00'),
(5, 5, 'Wtorek', '06:00:00', '18:00:00'),
(6, 5, 'Wtorek', '06:00:00', '18:00:00'),
(7, 6, 'Piątek', '06:00:00', '18:00:00'),
(8, 7, 'Poniedziałek', '06:00:00', '18:00:00'),
(9, 7, 'Piątek', '06:00:00', '18:00:00'),
(12, 8, 'Poniedziałek', '06:00:00', '18:00:00'),
(13, 8, 'Niedziela', '06:00:00', '18:00:00');
...
(12, '2023_01_13_175526_create_days', 1),
(13, '2023_01_13_233238_create_opinions', 2);
...
INSERT INTO `offeraddres` (`id`, `offer_id`, `miasto_id`, `ulica`, `numerulicy`, `telefon`) VALUES
(5, 3, 92, 'Papierowa', '13', 423141241),
(6, 3, 270, 'grzybowa', '44', 523523523),
(7, 4, 92, 'XD', '12', 121212121),
(8, 4, 92, 'dddd', 'ddd', 111111111);
...
INSERT INTO `opinions` (`id`, `users_id`, `user`, `opis`, `ocena`) VALUES
(18, 4, 'Michał P', 'pOLCAM', 4);
...
INSERT INTO `users` (`id`, `name`, `surname`, `date`, `email`, `email_verified_at`, `password`, `telephone`, `remember_token`, `created_at`, `updated_at`, `status`, `activated`) VALUES
(3, 'Michał', 'Pawlikowski', '2010-02-03', 'michal0725@gmail.com', NULL, '$2y$10$tF6oJR1Z6Ne0bDTQoF8FTu00crcKooe3Q2fjzZthm.d9nfBDbAaPu', 500312312, NULL, '2023-01-14 00:30:12', '2023-01-14 00:30:12', 1, 1),
(4, 'Jan', 'Testowy', '2022-12-29', 'test@test.pl', NULL, '$2y$10$.dHwKDjD2etQCW4gSW46iuv/9QhdX4KtclGCRy4p/6Uk3SV/GOT8u', 443322132, NULL, '2023-01-14 00:30:51', '2023-01-14 00:30:51', 0, 1);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `woje`
--
...
ALTER TABLE `days`
  ADD PRIMARY KEY (`id`),
  ADD KEY `days_offer_addres_id_foreign` (`offer_addres_id`);
...
ALTER TABLE `opinions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `opinions_users_id_foreign` (`users_id`);
...
--
ALTER TABLE `days`
  ADD CONSTRAINT `days_offer_addres_id_foreign` FOREIGN KEY (`offer_addres_id`) REFERENCES `offeraddres` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `opinions`
  ADD CONSTRAINT `opinions_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
